...
const isZerion = () => {
    if (typeof window === 'undefined')
        return false;
    const { ethereum } = window;
    return !!((ethereum === null || ethereum === void 0 ? void 0 : ethereum.isZerion) ||
        ((ethereum === null || ethereum === void 0 ? void 0 : ethereum.providers) &&
            (ethereum === null || ethereum === void 0 ? void 0 : ethereum.providers.find((provider) => provider.isZerion))));
};
                                        ...
                                        context.route === routes.CONNECTORS && (jsx(DisclaimerBackground, { initial: {
                                            ...
                                            ease: [0.25, 0.1, 0.25, 1.0],
                                                ...
                                                height: 32,
                                                    ...
                                                    context.signInWithEthereum ? (jsxs(Fragment, { children: [!isSignedIn && !((_g = context.options) === null || _g === void 0 ? void 0 : _g.hideTooltips) && (jsx(motion.div, { style: {
                                                                position: 'absolute',
                                                                inset: 0,
                                                                pointerEvents: 'none',
                                                    ...
                                                    !((_h = context.options) === null || _h === void 0 ? void 0 : _h.hideQuestionMarkCTA) && (jsx(InfoButton, { disabled: inTransition, "aria-label": flattenChildren(locales.moreInformation).toString(), onClick: onInfo, initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, transition: {
                                                        duration: mobile ? 0 : 0.1,
                                                        delay: mobile ? 0.01 : 0,
